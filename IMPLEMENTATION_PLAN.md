...
- [x] Build `popup.html` with inputs for adding words to blacklist.
- [x] Implement `popup.js` to save configuration to `chrome.storage`.
- [x] Add mode selector (Block/Mock/Mobb).

### Phase 3: Content Script Core
- [x] Create `content.js`.
- [x] Implement DOM Traversal to find text nodes.
- [x] Implement "Block" logic (hiding elements).

### Phase 4: Mock & Replace Logic
- [x] Implement Text Replacement logic ("Mock").
- [x] Connect "Mock" replacements to user settings.
